...
export function ProductDetailClient({ product, ratings }: Props) {
  ...
  const [displayPrice, setDisplayPrice] = useState(Number.parseFloat(product.price))
              ...
              <dl className="mt-3 grid grid-cols-3 gap-2 text-sm">
                {product.calories != null && (
                  <>
                    ...
                    <dd className="font-medium col-span-2">{product.calories}</dd>
                  </>
                )}
                ...
                {product.fiber != null && (
                  <>
                    <dt className="text-gray-500">Fiber</dt>
                    <dd className="font-medium col-span-2">
                      {product.fiber}
                      g
                    </dd>
                ...
                {product.sugar != null && (
                  <>
                    <dt className="text-gray-500">Sugar</dt>
                    <dd className="font-medium col-span-2">
                      {product.sugar}
                      g
                    </dd>
